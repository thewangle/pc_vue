...
export function getgoodBygoodsid(params) {
  let url = process.env.BASE_API + 'yii2/frontend/web/?r=goods/getgoodbygoodsid'
  return axios.post(url,params)
}

//根据用户id获取Goodsinfo--不传page--用于价格变动报表
export function getGoodsinfobyid(params) {
  let url = process.env.BASE_API + 'yii2/frontend/web/?r=goods/getgoodsinfobyid'
  return axios.post(url,params)
}
...
export function getgoodsinfofortab1(params) {
  let url = process.env.BASE_API + 'yii2/frontend/web/?r=goods/getgoodsinfofortab1'
  return axios.post(url,params)
}

//查询库存变化占比--用于库存报表--tab1的echorts的展示
export function getgoodschangefortab1(params) {
  let url = process.env.BASE_API + 'yii2/frontend/web/?r=goods/getgoodschangefortab1'
  return axios.post(url,params)
}

//查询库存变化趋势--用于库存报表--tab2的echorts的展示
export function getgoodschangeQushi(params) {
  let url = process.env.BASE_API + 'yii2/frontend/web/?r=goods/getgoodschangequshi'
  return axios.post(url,params)
}

//查询价格变化趋势--用于价格报表--echorts的展示
export function getpricechangeQushi(params) {
  let url = process.env.BASE_API + 'yii2/frontend/web/?r=goods/getpricechangequshi'
  return axios.post(url,params)
}
