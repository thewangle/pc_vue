<template>
  <div class="dashboard-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.numtype" placeholder="请选择出入库类别" clearable style="width: 200px;margin-left:10px;" class="filter-item" @change="handleFilter">
    ...
    <!-- 使用说明 -->
    <drawer title="库存变动记录页 - 使用说明" :visible.sync='dialogVisible11' width="500px" close-on-click-modal>
      <div class="smWrap">
        <div class="smB">概述：此页为库存变动记录的列表展示页</div>
        <div class="smContent">
          <span class="smContentB">变动列表：</span>
          <div class="smContentC">
            <div>1.展示账号下的商品的所有库存变动记录</div>
            <div>2.支持"商品名称"，"商品编码"的模糊查询</div>
            <div>2.支持按"商品分类"，"供应商"和"出/入库类别"查询</div>
          </div>
        </div>
        <div class="smContent">
